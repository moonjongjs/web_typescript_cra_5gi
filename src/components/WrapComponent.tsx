...
function WrapComponent(props: any) {
    ...
    // 서브페이지 메인1 신상품 상태관리
    const [state, setState]   = React.useState<ProductType>(props.제품);             // 탑모달
    ...
    return (
        <div id='wrap'>
            ...
            {/* {   //서브 메인2(베스트) 컴포넌트 : 제이쿼리 => AJAX /  리액트 => AXIOS
                isSubMain2 && <SubMain2Component  베스트={state.베스트}  /> 
            }

            {   //서브 메인3(알뜰상품) 컴포넌트 : 제이쿼리 => AJAX /  리액트 => AXIOS
                isSubMain3 && <SubMain3Component  베스트={state.알뜰상품}  /> 
            } */}
